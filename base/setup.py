...
aveiro.add_straight_neighbor(faro, 366)
braga.add_straight_neighbor(faro, 454)
braganca.add_straight_neighbor(faro, 487)
beja.add_straight_neighbor(faro, 99)
castelo.add_straight_neighbor(faro, 280)
coimbra.add_straight_neighbor(faro, 319)
evora.add_straight_neighbor(faro, 157)
faro.add_straight_neighbor(faro, 0)
guarda.add_straight_neighbor(faro, 352)
leiria.add_straight_neighbor(faro, 278)
lisboa.add_straight_neighbor(faro, 195)
porto.add_straight_neighbor(faro, 418)
vila.add_straight_neighbor(faro, 429)
viseu.add_straight_neighbor(faro, 363)
viana.add_straight_neighbor(faro, 473)
setubal.add_straight_neighbor(faro, 168)
portalegre.add_straight_neighbor(faro, 228)
santarem.add_straight_neighbor(faro, 231)
