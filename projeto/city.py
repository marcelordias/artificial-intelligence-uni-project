...
class City:
    ...
    def add_neighbor(self, city, cost):
        ...
        print('Cidade {} adicionada como vizinha de {}'.format(city.name, self.name)) if Config.TESTING else None # Prints the message if the program is in testing mode
        city.push(self, cost) # Adds the city to the list of neighbors of the neighbor
        print('Cidade {} adicionada como vizinha de {}'.format(self.name, city.name)) if Config.TESTING else None # Prints the message if the program is in testing mode
    ...
    def add_straight_line(self, city, cost):
        ...
        print('Cidade {} adicionada como linha reta de {}'.format(city.name, self.name)) if Config.TESTING else None # Prints the message if the program is in testing mode